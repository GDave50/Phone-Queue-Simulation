...
/**
 * This Controller uses the SynchronizedQueue created by myself.
...
public class Controller1 implements Runnable {
	...
	final SynchronizedQueue callQueue;
	 ...
	 * @param queueSize size of the call queue
	 */
	public Controller1(int nOperators, int queueSize) {
		callQueue = new SynchronizedQueue(queueSize);
